  ...
  const mockBrokers: Broker[] = [
    {
      ...
      scamReportCount: 2,
      isVerified: true,
      regulationSummary: "Regulated by ASIC (Australia), CySEC (Cyprus)",
    },
    {
      id: "2",
      name: "Pepperstone",
      ...
      scamReportCount: 1,
      isVerified: true,
      regulationSummary: "Regulated by FCA (UK), ASIC (Australia)",
    },
    {
      id: "3",
      name: "FXTM",
      slug: "fxtm",
      websiteUrl: "https://fxtm.com",
      logoUrl: null,
      overallRating: 4.1,
      reviewCount: 156,
      scamReportCount: 5,
      isVerified: false,
      regulationSummary: "Regulated by CySEC (Cyprus), FCA (UK)",
    },
    {
      id: "4",
      name: "ScamBroker Ltd",
      ...
      scamReportCount: 45,
      isVerified: false,
      regulationSummary: "No verified regulation",
    },
  ];

  const filteredBrokers = mockBrokers
    .filter((broker) => {
