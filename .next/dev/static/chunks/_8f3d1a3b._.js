...
"[project]/shared/threadUtils.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function generateSlug(title, maxLength = 60) {
    return title.toLowerCase().normalize("NFD") // Decompose Unicode characters
    .replace(/[\u0300-\u036f]/g, "") // Remove diacritics
    .replace(/[^a-z0-9\s-]/g, "") // Keep only letters, numbers, spaces, hyphens
    .trim().split(/\s+/).filter((word)=>!STOP_WORDS.has(word)) // Remove stop words
    .join("-").replace(/-+/g, "-") // Replace multiple hyphens with single
    .substring(0, maxLength).replace(/-$/, ""); // Remove trailing hyphen
}
function generateFullSlug(categorySlug, subcategorySlug, title) {
...
function generateMetaDescription(body, seoExcerpt) {
    ...
    const cleaned = firstParagraph.replace(/[#*_`~\[\]]/g, "") // Remove markdown
...
function suggestTags(title, body) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$tradingMetadata$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["extractPotentialTags"])(text);
}
function deduplicateTags(instruments, timeframes, strategies, hashtags, maxTags = 12) {
    // Normalize hashtags (remove #, lowercase)
    const normalizedHashtags = hashtags.map((tag)=>tag.replace(/^#/, "").toLowerCase().trim());
    ...
    uniqueHashtags.forEach((hashtag)=>{
        if (uniqueInstruments.has(hashtag) || uniqueTimeframes.has(hashtag.toUpperCase()) || uniqueStrategies.has(hashtag)) {
...
function generateStructuredData(threadType, thread) {
    const basePosting = {
...
function calculateEngagementScore(metrics) {
    return metrics.views * 1 + metrics.replies * 3 + metrics.likes * 4 + metrics.bookmarks * 2 + metrics.shares * 5 - (metrics.reports || 0) * 5;
}
function countWords(text) {
    return text.trim().split(/\s+/).filter((word)=>word.length > 0).length;
}
function isTitleTooShouty(title) {
...
function cleanHashtags(hashtags) {
    return hashtags.map((tag)=>tag.replace(/^#/, "").toLowerCase().trim()).filter((tag)=>tag.length >= 2 && tag.length <= 24 && /^[a-z0-9-]+$/i.test(tag));
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tanstack/react-query/build/modern/useQuery.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$tradingMetadata$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/shared/tradingMetadata.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$threadUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/shared/threadUtils.ts [app-client] (ecmascript)");
...
function ThreadComposeClient({ categories }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThreadComposeClient.useEffect": ()=>{
            setWordCount((0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$threadUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["countWords"])(watchedValues.body || ""));
    ...
    const createThreadMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "ThreadComposeClient.useMutation[createThreadMutation]": async (data)=>{
                return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$queryClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/api/threads", {
                    method: "POST",
    ...
    const handleFileUpload = async (event)=>{
        ...
        try {
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$queryClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/api/upload", {
                method: "POST",
                body: formData,
                headers: {}
            });
...
_s1(ThreadComposeClient, "9IICPXBJnMD3vnuCw54pDiKXtyY=", false, function() {
    return [
...
//# sourceMappingURL=_8f3d1a3b._.js.map