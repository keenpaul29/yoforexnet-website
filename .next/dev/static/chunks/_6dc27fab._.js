...
const threadFormSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    ...
    body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().min(300, "A little more context helps people reply. Two more sentences?").max(50000, "Body is too long"),
    ...
    const createThreadMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        ...
        onSuccess: {
            "ThreadComposeClient.useMutation[createThreadMutation]": (response)=>{
                ...
                toast({
                    title: "Posted!",
                    description: response.message + ` (+${response.coinsEarned} coins)`,
                    duration: 5000
                });
...
_s1(ThreadComposeClient, "DZDPVFRURQHXKXWH0PMu67r2tmg=", false, function() {
    return [
...
//# sourceMappingURL=_6dc27fab._.js.map